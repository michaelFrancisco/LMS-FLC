...
using BLM.ChatClientCS.Enums;
using BLM.ChatClientCS.Models;
using BLM.ChatClientCS.Commands;
...
namespace BLM.ChatClientCS.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private async Task<bool> Login()
        {
            try
            {
                ...
                if (users != null)
                {
                    users.ForEach(u => Participants.Add(new Participant { Name = CurrentUser.name, Photo = u.Photo }));
